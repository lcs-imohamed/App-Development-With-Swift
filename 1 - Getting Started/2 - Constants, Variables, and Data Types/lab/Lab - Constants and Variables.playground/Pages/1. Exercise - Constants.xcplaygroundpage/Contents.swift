 ...
 */
print("The above code does not compile because type safety prevents me from redeclaring an immutable constant. Since the integer I tried to add was not = to the constant integer.")
